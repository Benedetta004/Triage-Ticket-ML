...
def assegna_priorita(titolo, descrizione, priorita_originale):
    ...
    if any(parola in combinato_testo for parola in alta_parole):
        punteggio += 2
    ...
    alta_moderate = ["pagamento", "bonifico", "scadenza", "anomalia", "malfunzionamento",
                     ...
                     "sincronizzazione"]
    if any(parola in combinato_testo for parola in alta_moderate):
        punteggio += 1
    ...
    if any(parola in combinato_testo for parola in media_parole):
        punteggio -= 1
    ...
    if any(parola in combinato_testo for parola in bassa_parole):
        punteggio -= 2
    ...
    if punteggio >= 3:
        ...
        return "alta" if random.random() < 0.50 else "media"
   
    elif punteggio <= -2:
        return "bassa"

    elif punteggio <= -1:
        return "bassa" if random.random() < 0.50 else "media"
